...
class ReviewForm extends React.Component {
  ...
  render() {
      ...
      return (
        <div className="review-form-loading-container">
          ...
          {this.props.errors.map((error, idx) => (
            <li className="review-form-error" key={idx}>
              {error}
            </li>
          ))}
        </div>
    ...
    return (
      ...
      >
        {this.props.errors.map((error, idx) => (
          <li className="review-form__error" key={idx}>
            {error}
          </li>
        ))}
